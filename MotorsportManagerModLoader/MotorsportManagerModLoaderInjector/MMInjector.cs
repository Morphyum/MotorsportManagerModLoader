...
namespace MotorsportManagerModLoader {
    ...
    internal static class BTMLInjector {
        private const string INJECTED_DLL_FILE_NAME = "MotorsportManagerModLoader.dll";
        private const string INJECT_TYPE = "MotorsportManagerModLoader.MotorsportManagerModLoader";
        ...
        private const string HOOK_TYPE = "App";
        ...
        private static int Main(string[] args) {
            ...
            WriteLine("MotorsportManagerModLoader Injector");
            WriteLine("----------------------------");
